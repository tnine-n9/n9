...
ah("UISizeConstraint",{
MinSize=Vector2.new(60,0),
MaxSize=Vector2.new(110,999),
}),
}),
ah("Frame",{
...
ColorSequenceKeypoint.new(0.5,Color3.fromRGB(160,160,175)),
...
Size=UDim2.new(1,0,1,ap.ShowTabTitle and-((Window.UIPadding*2.4)+12)-42 or-42),
BackgroundTransparency=1,
ScrollBarThickness=0,
ElasticBehavior="Never",
CanvasSize=UDim2.new(0,0,0,0),
...
ah("UIPadding",{
PaddingTop=UDim.new(0,not Window.HidePanelBackground and 12 or 8),
PaddingLeft=UDim.new(0,not Window.HidePanelBackground and 12 or 8),
PaddingRight=UDim.new(0,not Window.HidePanelBackground and 12 or 8),
PaddingBottom=UDim.new(0,not Window.HidePanelBackground and 12 or 8),
}),
})
ap.UIElements.ElementsHolder=ah("Frame",{
Size=UDim2.new(1,0,0,0),
AutomaticSize="Y",
BackgroundTransparency=1,
...
af.AddSignal(ap.UIElements.ContainerFrame.ChildAdded,function(child)
if child:IsA("UIListLayout")or child:IsA("UIPadding")or child:IsA("Frame")then return end
child.Parent=ap.UIElements.ElementsHolder
end)
...
aj(aq.UIElements.Main.Frame.TextLabel,0.15,{TextTransparency=0.45}):Play()
if aq.UIElements.Icon and not aq.IconColor then
aj(aq.UIElements.Icon.ImageLabel,0.15,{ImageTransparency=0.5}):Play()
end
aq.Selected=false
end
end
...
Color=ColorSequence.new{
ColorSequenceKeypoint.new(0,Color3.fromRGB(255,255,255)),
ColorSequenceKeypoint.new(0.5,Color3.fromRGB(180,180,195)),
ColorSequenceKeypoint.new(1,Color3.fromRGB(255,255,255))
}
}),
}),
...
ao(as.UIElements.SideBar,as.UIElements.SideBarContainer,as,3)
end
as.UIElements.MainBar=ak("Frame",{
Size=UDim2.new(1,0,1,-as.Topbar.Height-36-42),
...
Position=UDim2.new(1,-as.UIPadding,1,-as.UIPadding),
AnchorPoint=Vector2.new(1,1),
BackgroundTransparency=1,
Visible=as.User.Enabled or false,
Parent=as.UIElements.MainBar,
ZIndex=10,
},{
...
as.UIElements.SearchFrame=ak("Frame",{
Size=UDim2.new(1,0,0,42),
Position=UDim2.new(0,0,1,0),
AnchorPoint=Vector2.new(0,1),
BackgroundTransparency=1,
...
ak("Frame",{
Size=UDim2.new(1,-as.UIPadding*2,0,1),
Position=UDim2.new(0,as.UIPadding,0,0),
BackgroundTransparency=.7,
ThemeTag={
BackgroundColor3="Text"
},
...
local G=a.load'X'
local H=false
local J=am("Search","search",as.UIElements.SearchFrame,true)
J.Size=UDim2.new(1,-as.UIPadding*2,0,36)
J.Position=UDim2.new(0,as.UIPadding,0.5,0)
